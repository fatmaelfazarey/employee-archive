...
// auto-generated from src/shared/evaluation-config.js
(function () {
  ...
  //   { key: 'work_quantity', label: 'كمية العمل', max: 15 , group: 'أولاً: اداءالعمل و مستواه'},
  //   { key: 'work_quality', label: 'درجة إتقان العمل', max: 15 },
  //   { key: 'improvement', label: 'درجة مشاركته في تحسين مستوى أداء العمل', max: 20 },
  //   { key: 'followup', label: 'درجة متابعة أداء المعلمين', max: 10 },
  //   { key: 'leadership', label: 'القدرة على القيادة والتوجيه', max: 10 },
  //   { key: 'qualifications', label: 'الشهادات والدرجات العلمية والدورات التدريبية', max: 10 },
  //   { key: 'behavior', label: 'سلوكياته مع إدارة المدرسة والإدارة التعليمية', max: 10 },
  //   { key: 'discipline', label: 'الانضباط في العمل', max: 10 },
  // ];
...
const evaluationItems = [
  ...
  window.EVALUATION_CONFIG = module.exports;
})();